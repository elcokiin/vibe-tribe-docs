...
- `planning/references/`: templates, examples, and supporting material.
- `execution/sprint-1..4/`: execution evidence and documentation organized by sprint.
- `close-down/`: final project closure documentation.

Folders that do not yet have final content include `.gitkeep` files to preserve the structure in Git.
